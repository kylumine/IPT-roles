        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                  ...
                  <div class="flex flex-row items-center justify-between space-x-4 display-6">
                     <h1 class="m-1 fw-bold">MOVIE LIST</h1>
                           ...
                           <form action="{{ route('movie.store') }}" method="POST">
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="mb-3">
                                       ...
                                       <textarea class="form-control" id="genre" name="genre" rows="3" required></textarea>
                                 </div>
                                 <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="imageUrl" name="imageUrl" rows="3" required></textarea>
                                 </div>
                              </div>
